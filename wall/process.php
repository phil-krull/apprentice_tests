<?php 
  ...
  if(isset($_POST['action']) && $_POST['action'] == 'addComment'){
    ...
    $dbQuery = "INSERT into comments (user_id, content, created_at, updated_at) VALUES ('{$_SESSION['user_id']}', '{$content}', NOW(), NOW())";
    run_mySQL_query($dbQuery);
  ...
  if(isset($_POST['action']) && $_POST['action'] == 'addPost'){
    ...
    $dbQuery = "INSERT into posts (user_id, comment_id, content, created_at, updated_at) VALUES ('{$_SESSION['user_id']}', '{$comment_id}', '{$content}', NOW(), NOW())";
    run_mySQL_query($dbQuery);
